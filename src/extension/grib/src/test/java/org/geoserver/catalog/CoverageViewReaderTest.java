...
public class CoverageViewReaderTest extends GeoServerSystemTestSupport {
    ...
    private void addViewToCatalog() throws Exception {
        ...
        CoverageStoreInfo storeInfo = cat.getCoverageStoreByName("regional_currents");
       
        CatalogBuilder builder = new CatalogBuilder(cat);
        builder.setStore(storeInfo);

        CoverageInfo coverageInfo = coverageView.createCoverageInfo("regional_currents", storeInfo, builder);
     ...
     */
    @Test
    public void testCoverageViewMultiBand() throws Exception {
